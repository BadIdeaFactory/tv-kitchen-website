    ...
    <Container maxWidth="sm">
      ...
      <Copy>
        <p>
          ...
          future political ads, chyrons, talking points, and more. Participants will be able to develop, share, and use
          free software tools to extract data from TV and share metadata safely with a wider community. The more people
          who use TV Kitchen, the more plentiful and rich our information and collaborations.
        </p>
        ...
        <p>
          ...
          for news. Major media conglomerates, including Sinclair, Tegna, and Nexstar, have been snapping up these local
          stations, and{' '}
        ...
        <p>
          But for researchers and journalists, local TV remains opaque. If you want to analyze local coverage of recent
          protests for racial justice, the pandemic, or the election, you need to pay an expensive private firm or
          ignore this major source of information.
        </p>
        ...
        <p>
          ...
          <a href="https://www.theatlantic.com/politics/archive/2016/02/super-campaign-dodger/462531/">video game</a>, a
          visual on how CNN, Fox, and MSNBC{' '}
          <a href="https://www.nytimes.com/interactive/2016/09/29/us/elections/debate-moments.html">
            covered presidential debates
          </a>
          , and <a href="https://politicaladarchive.org/ad/PolAd_DonaldTrump_5rk9i">fact-checks</a> of political ads. TV
          Kitchen takes this same functionality and invites the public to collaborate.
        </p>
      </Copy>
    </Container>
  );
